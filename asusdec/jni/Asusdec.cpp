...
static const JNINativeMethod gMethods[] = {
        { "toggleTouchpad", "(Z)Z", (void *) Java_com_cyanogenmod_asusdec_AsusdecNative_toggleTouchpad }
};
...
jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    if(android::AndroidRuntime::registerNativeMethods(
            env, "com/cyanogenmod/asusdec/AsusdecNative", gMethods,
